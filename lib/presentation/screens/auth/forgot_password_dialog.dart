...
import 'package:akuhadir/core/constants/app_colors.dart';import 'package:akuhadir/presentation/providers/auth_provider.dart';import 'package:akuhadir/presentation/widgets/custom_snackbar.dart';import 'package:akuhadir/presentation/widgets/neumorphic_button.dart';import 'package:akuhadir/presentation/widgets/neumorphic_text_field.dart';
...
class _ForgotPasswordDialogState extends State<ForgotPasswordDialog> {
  ...
  Future<void> _handleSendOtp() async {
    ...
    if (success) {
      ...
      CustomSnackBar.showError(context, auth.errorMessage ?? 'Gagal mengirim OTP');
    }
  }
  ...
  Future<void> _handleResetPassword() async {
    ...
    if (success) {
      ...
      CustomSnackBar.showError(context, auth.errorMessage ?? 'Gagal memperbarui password');
    }
  }
